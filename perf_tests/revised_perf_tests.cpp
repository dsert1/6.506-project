...
int main(int argc, char **argv) {
    ...
    // graveyard filters
    RedistributionPolicy policies[] = {no_redistribution, between_runs, between_runs_insert, evenly_distribute};
    std::string filter_names[] = {"no_redist", "between_runs", "between_runs_insert", "evenly_dist"};
